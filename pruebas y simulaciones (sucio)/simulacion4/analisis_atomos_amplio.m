...
archivo_salida = 'resultados_radio_vs_atomos_amplio.txt';
fid = fopen(archivo_salida, 'w');
fprintf(fid, '=================================================================\n');
fprintf(fid, '   ANALISIS: RADIO OPTIMO (CDF=0.1) vs CANTIDAD DE ATOMOS (N_RIS)\n');
fprintf(fid, '=================================================================\n');
fprintf(fid, 'Factor 0.5 | Modo Inclusivo (Rango Amplio) | 50 Setups\n\n');
fclose(fid);
...
for s_idx = 1:length(atomos)
    ...
    % Usamos un paso de 20m para abarcar de 10 a 250
