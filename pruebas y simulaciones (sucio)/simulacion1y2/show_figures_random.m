...
carpeta = 'results/'; 
archivos = {'all-assigned-randomsetup.fig', 'no-assignment-randomsetup.fig', 'no-ris-randomsetup.fig', 'random-assignment-randomsetup.fig'};
...
figPrincipal = figure('Name', 'Resultados Setup Aleatorio', 'Color', [0.15 0.15 0.15]); 
...
savefig(figPrincipal, fullfile('results', 'NoRIS_vs_RIS_random.fig'));
print(figPrincipal, fullfile('results', 'NoRIS_vs_RIS_random.png'), '-dpng', '-r300');
fprintf('Figura guardada: NoRIS_vs_RIS_random.png\n');