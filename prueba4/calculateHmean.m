function [HMean_X_Y, gainOverNoisedB, probLoS_X_Y, shadowCorrMatrix_X_Y, shadowAPrealizations_X_Y, R_X_Y_1, R_X_Y_2] = calculateHmean(X_Y, n, M, N_AP, N_RIS,dist_X_Y, betaLos_X_Y, fc, d_BP_eff, h_1, h_2, LoS, probLoS_X_Y, maxdistances, UEposition, UEpositions, RISpositions, APpositions, wrapLocations, APpositionsWrapped, whichpos, sigma_sf, decorr, shadowCorrMatrix_X_Y, shadowAPrealizations_X_Y, noiseVariancedBm, prenargin, R_X_Y_1, R_X_Y_2, HMean_X_Y, ASD_varphi, antennaSpacing)
...
if LoS==2
    probLoS_X_Y(:,n)=(rand<((maxdistances-dist_X_Y(:,n))./maxdistances));
end
