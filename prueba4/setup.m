...
%% Setups
    ...
    for k = 1:K
        ...
        if LoS==2
            probLoS_AP_UE(:,k)=0;%(rand<((maxdistances-dist_AP_UE(:,k))./maxdistances));
        ...
        for s = 1:S
            ...
            % Componente determinista LoS
            arrayResp_RIS_UE = exp(1i * pi * (0:N_RIS-1).' * sin(angletoUE_varphi));
