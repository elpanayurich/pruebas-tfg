...
for k = 1:K
    ...
    X_Y = "AP_UE";
    [HMean_AP_UE, gainOverNoisedB, probLoS_AP_UE, shadowCorrMatrix_AP_UE, shadowAPrealizations_AP_UE, R_AP_UE, ~] = calculateHmean(X_Y, k, L, N_AP, N_RIS, dist_AP_UE, betaLoS_AP_UE, fc, d_BP_eff, h_BS, h_UT, LoS, probLoS_AP_UE, maxdistances, UEposition, UEpositions, RISpositions, APpositions, wrapLocations, APpositionsWrapped, whichpos, sigma_sf, decorr, shadowCorrMatrix_AP_UE, shadowAPrealizations_AP_UE, noiseVariancedBm, nargin, R_AP_UE, 0, HMean_AP_UE, ASD_varphi, antennaSpacing);
    ...
    % ----- CALCULOS RIS-UE
    X_Y = "RIS_UE";
    [HMean_RIS_UE, ~, probLoS_RIS_UE, shadowCorrMatrix_RIS_UE, shadowAPrealizations_RIS_UE, R_RIS_UE, ~] = calculateHmean(X_Y, k, S, N_AP, N_RIS, dist_RIS_UE, betaLoS_RIS_UE, fc, d_BP_eff, h_RIS, h_UT, LoS, probLoS_RIS_UE, maxdistances, UEposition, UEpositions, RISpositions, APpositions, wrapLocations, APpositionsWrapped, whichpos, sigma_sf, decorr, shadowCorrMatrix_RIS_UE, shadowAPrealizations_RIS_UE, noiseVariancedBm, nargin, R_RIS_UE, 0, HMean_RIS_UE, ASD_varphi, antennaSpacing);
...
for s = 1:S
    ...
    X_Y = "AP_RIS";
    [HMean_AP_RIS, ~, probLoS_AP_RIS, shadowCorrMatrix_AP_RIS, shadowAPrealizations_AP_RIS, R_AP_RIS1, R_AP_RIS2] = calculateHmean(X_Y, s, L, N_AP, N_RIS, dist_AP_RIS, betaLoS_AP_RIS, fc, d_BP_eff, h_BS, h_RIS, LoS, probLoS_AP_RIS, maxdistances, UEposition, UEpositions, RISpositions, APpositions, wrapLocations, APpositionsWrapped, whichpos, sigma_sf, decorr, shadowCorrMatrix_AP_RIS, shadowAPrealizations_AP_RIS, noiseVariancedBm, nargin, R_AP_RIS1, R_AP_RIS2, HMean_AP_RIS, ASD_varphi, antennaSpacing);
