...
% tau_p_array
% main1;
% savefig(gcf, fullfile(figures_dir, 'Closest_if_100m.fig'));
% close(gcf);
...
fprintf('Running Case 13: RISs assigned to closest if in a certain range (360m), if not, set to random config...\n');
max_dist = 360;
[RISassignment_array, assigned_counts, unassigned_counts] = getRISAssignments_closest_unsassigned_RISs(indices, max_dist);
assigned_counts
RISassignment_array
