function [R_AP_UE,R_AP_RIS1,R_AP_RIS2,R_RIS_UE,pilotIndex,D,HMean_AP_UE, HMean_AP_RIS, HMean_RIS_UE, probLoS_AP_UE, probLoS_RIS_UE, dist_RIS_UE, UEpositions] = setup(L,K,N_AP,N_RIS,tau_p,seed,ASD_varphi,LoS,fc,S, setup_seed)
%% Definir escenario
...
file_index = setup_seed - 9;
filename = "positions/positions" + file_index + ".mat";
save(filename, "APpositions", "RISpositions", "UEpositions", "dist_RIS_UE")
end